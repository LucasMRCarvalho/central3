...
<body>
    ...
    <main class="quebra">
        <div class="container">
            <h2>Oganizador de Logins</h2>
            <p>
                Use esta ferramenta para organizar logins de forma rápida. No campo "Texto Original",
                você pode ver o formato esperado para os logins. Atenção: as partes dentro de colchetes `[ ]` não devem ser alteradas,
                pois são campos fixos. Insira a lista de e-mails e senhas no formato "email:senha" (um par por linha) no campo "Lista de Email e Senha". 
                Ao clicar em "Substituir", os dados serão organizados automaticamente no formato correto. 
                Você também pode copiar o resultado para uso posterior com o botão "Copiar Resultado".
            </p>
        </div>
        <div class="container">
        <label for="textoOriginal">Texto Original</label>
        <textarea id="textoOriginal" rows="4" cols="50">/addlogin===NOME DO LOGIN===[EMAIL]===[SENHA]===VALOR===VALIDADE===DESCRIÇÃO</textarea>
        <br>
        <label for="listaDados">Lista de Email e Senha (um par em cada linha)</label>
        <textarea id="listaDados" rows="4" cols="50">
email1@example.com:senha1
email2@example.com:senha2
email3@example.com:senha3
        </textarea>
        <br>
        <button onclick="substituirListaEmailSenha()">Substituir</button>
        <button onclick="limparCampos()">Limpar</button>
        <br>
        <label for="textoResultado">Resultado</label>
        <textarea id="textoResultado" rows="4" cols="50" readonly></textarea>
        <br>
