...
<body>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <div>
                        ...
                        <li class="active"><a href="quebra.php">Quebra de linhas</a></li>
                    </div>
                </ul>
           </li>
            <li>
    ...
    <main class="quebra">
        <div class="container">
            <h2>Quebra de linhas automático</h2>
            <p>
                Com essa ferramenta, você pode transformar seu texto normal em um formato com quebras de linha automáticas.
                Escreva seu texto na caixa "Texto Normal" e clique no botão "Transformar Quebra de Linhas". 
                O resultado será exibido na caixa abaixo, onde as quebras de linha são representadas por '\n'. 
                Depois, basta copiar o texto formatado com o botão "Copiar Resultado".
            </p>
        </div>
        <div class="container">
        <label for="textoNormal">Texto Normal</label>
        <textarea id="textoNormal"></textarea>
        <br>
        <button onclick="transformarQuebraDeLinha()">Transformar Quebra de Linhas</button>
        <br>
